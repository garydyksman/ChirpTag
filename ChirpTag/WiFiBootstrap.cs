...
namespace ChirpTag
{
    ...
    public static class WiFiBootstrap
    {
        ...
        {
            ManualResetEvent m = _scanCompleteSignal;
            if (m != null)
            {
                m.Set();
            }
        ...
        private static WifiBootOutcome TryConnectViaScan()
        {
            ...
            try
            {
                ...
                string targetSsid = ChirpTagSettings.WifiSsid;
                string psk = ChirpTagSettings.WifiPassword ?? string.Empty;
                ...
                foreach (WifiAvailableNetwork net in report.AvailableNetworks)
                {
                    ...
                    wifi.Disconnect();
                    WifiConnectionResult result = wifi.Connect(net, WifiReconnectionKind.Automatic, psk);
