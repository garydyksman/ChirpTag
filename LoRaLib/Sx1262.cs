...
namespace Iot.Device.LoRa.Sx1262
{
    ...
    public sealed class LoRaMessage
    {
        ...
        internal LoRaMessage(byte[] payload, int rssi, float snr)
        {
            Payload = payload;
            Rssi = rssi;
            Snr = snr;
    ...
    /// </summary>
    public class Sx1262 : IDisposable
    {
        // ---------------------------------------------------------------
        ...
        /// <summary>
        /// Raised on the poll thread when a packet is successfully received.
        /// Wire this up before calling StartPolling().
        /// </summary>
        ...
        /// <summary>
        /// Pulses RST low for 100 ms then waits for BUSY to clear.
        /// Must be the very first call after construction.
        /// </summary>
        public void Reset()
        {
            _resetPin.Write(PinValue.High);
        ...
        /// <summary>
        /// Full chip initialisation for 868 MHz LoRa.
        /// Call once after Reset(). Leaves chip in STDBY_XOSC.
        /// </summary>
        ...
        /// <summary>Sets the RF frequency in Hz.</summary>
        ...
        /// <summary>
        /// Sends a byte array over LoRa. Blocks until TxDone or timeout.
        /// Stops the poll thread for the duration, restarts it after.
        /// Do not call from a GPIO interrupt handler — use a flag and
        /// call from the main thread instead.
        /// </summary>
        ...
        /// <summary>
        /// Starts a background thread that polls DIO1 and fires
        /// PacketReceived for each valid packet.
        /// Wire up PacketReceived before calling this.
        /// </summary>
        ...
        /// <summary>Signals the poll thread to stop and waits for it to exit.</summary>
